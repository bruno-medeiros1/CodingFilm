...
namespace Utad.Lab.CodingFilm.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Verificação por email enviada. Verifica o teu email.");
                return Page();
            }
            ...
            await _emailSender.SendEmailAsync(
                ...
                $"Confirma a tua conta clicando aqui: <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'></a>.");
