            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //  Adicionamos um registo na tabela perfil vazio pois 
                        //  não houve tempo de implementar a API da google para retribuir a 
                        //  info do perfil do google do usuario que usar esta opção
